...
plot(12, 0, 0, "plots/vis/D_6/contour/K0_type1.png", line=np.pi/12, title=r"$\{e\}$", ylabel="Type 1")
plot(12, 1, 0, "plots/vis/D_6/contour/K0_type2.png", line=np.pi/12, ylabel="Type 2")
plot(6, 0, np.pi/12, "plots/vis/D_6/contour/K1_type1.png", line=np.pi/12, title=r"$\{e, t\}$")
plot(6, 1, np.pi/12, "plots/vis/D_6/contour/K1_type2.png", line=np.pi/12)
plot(6, 0, -5*np.pi/12, "plots/vis/D_6/contour/K2_type1.png", line=np.pi/12, title=r"$\{e, r^3t\}$")
plot(6, 1, -5*np.pi/12, "plots/vis/D_6/contour/K2_type2.png", line=np.pi/12)
